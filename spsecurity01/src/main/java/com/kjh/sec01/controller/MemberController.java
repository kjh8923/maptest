...
import com.kjh.sec01.memberCommand.JoinCommand;
import com.kjh.sec01.memberCommand.MemberCommand;
...
public class MemberController {
	...
	//로그아웃시 processLogin?logout=1로 호출하거나 form이 아닌 <a href="processLogin?log=1">으로 호출시에 사용 
	@RequestMapping(value = "/processLogin", method= {RequestMethod.GET, RequestMethod.POST})
	public ModelAndView processLogin(
			//@RequestParam(value = "log", required = false)는 request파라메타값을 변수에 사용 false이면 사용안해도 됨
	...
	@RequestMapping("/main") //로그인 성공 시 이동페이지
	public String main() {
		return "main_view";
	}
}
