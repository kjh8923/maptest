...
import com.project.init.command.PlanListInsertCommand;
...
public class FeedController {
	...
	@RequestMapping(value="/insertPlanList", produces = "application/text; charset=UTF8")
	@ResponseBody
	public String insertPlanList(HttpServletRequest request, HttpServletResponse response, Model model) {
		System.out.println("insertPlanList");
		comm = new PlanListInsertCommand();
		comm.execute(request, model);
